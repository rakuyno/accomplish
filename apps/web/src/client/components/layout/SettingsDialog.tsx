...
import { AgentsPanel } from '@/components/settings/agents/AgentsPanel';
import { Key, Lightning, Microphone, Info, Plugs, Robot } from '@phosphor-icons/react';
import { cn } from '@/lib/utils';
import logoImage from '/assets/logo-1.png';

const TABS = [
  { id: 'providers' as const, labelKey: 'tabs.providers', icon: Key },
  { id: 'agents' as const, labelKey: 'tabs.agents', icon: Robot },
...
interface SettingsDialogProps {
   ...
   */
  initialTab?: 'providers' | 'voice' | 'skills' | 'connectors' | 'agents' | 'about';
}
...
export function SettingsDialog({
  ...
  const [activeTab, setActiveTab] = useState<
    'providers' | 'voice' | 'skills' | 'connectors' | 'agents' | 'about'
  >(initialTab);
